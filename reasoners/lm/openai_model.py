...
class OpenAIModel(LanguageModel):
    def __init__(
        ...
        usage_callback: Optional[Callable[[int, int, int], None]] = None,
    ):
        self.model = model
        ...
        self.usage_callback = usage_callback  # (prompt_tokens, completion_tokens, total_tokens) -> None
        ...
        for i in range(1, retry + 1):
            try:
                ...
                if is_instruct_model:
                    ...
                    if self.usage_callback and getattr(response, "usage", None):
                        u = response.usage
                        self.usage_callback(
